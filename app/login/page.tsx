...
export default function LoginPage() {
  ...
  return (
    <main className="flex-1 flex items-center justify-center p-6 bg-linear-to-b from-black via-zinc-950 to-zinc-700 min-h-screen">
      <div className="bg-zinc-900 p-8 rounded-xl h-[500px] shadow-sm border border-zinc-700 w-full max-w-md flex flex-col justify-between">
        <div className="flex flex-col items-center mb-8">
          <h1 className="text-2xl font-bold text-zinc-200">Sign In</h1>
          <div className="border-2 border-amber-400 w-14 h-1 bg-amber-400 rounded-xl" />
        </div>

        <form onSubmit={handleSubmit(handleLogin)} className="space-y-6 flex-1 flex flex-col justify-center">
          <div>
